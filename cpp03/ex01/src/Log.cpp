...
{
	cout << "🤖   " << type << " " << name << " was constructed." << endl;
}
...
{
	cout << "🗡️    " << type << " " << name << " attacks " << target << " causing " << attackDamage
		 << " points of damage!" << endl;
}

void Log::beRepairedLog(string type, string name, unsigned int amount, int hitPoint, int energyPoints)
{
	cout << "❤️‍🩹  " << type << " " << name << " was repaired for " << amount << " hit points." << endl;
	cout << "❤️‍🩹  ClapTrap " << name << " has now " << hitPoint << " hit points left." << endl;
	cout << "❤️‍🩹  ClapTrap " << name << " has now " << energyPoints << " energy points." << endl;
}

void Log::takeDamageLog(string type, string name, unsigned int amount, int hitPoint)
{
	cout << "💔   " << type << " " << name << " takes " << amount << " points of damage !" << endl;
	cout << "💔   " << type << " " << name << " has now " << hitPoint << " hit points left." << endl;
}
...
void Log::ScavTrapAttackLog(string type, string name, string target, int attackDamage)
{
	cout << "🔪   " << type << " " << name << " attacks " << target << " causing " << attackDamage
		<< " points of damage!" << endl;
}